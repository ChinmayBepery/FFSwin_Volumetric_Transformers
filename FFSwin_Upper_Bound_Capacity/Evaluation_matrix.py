...
def evaluate_ffswin_tmi():
    ...
    data_dir = r"G:\My Drive\OCT_Project_PhD_Implementation\Experiment_0_FFSwin_Pseudo_3D_Model_main_upper_bound\local_data_clean"
    model_path = r"models\classifier_best_100_used_here_as_final.pth"

    save_dir = "./ffswin_test_results_upper_bound_final"
    ...
    plt.title(f"FFSwin Confusion Matrix\nAcc={accuracy_percent:.2f}%")
    plt.tight_layout()
