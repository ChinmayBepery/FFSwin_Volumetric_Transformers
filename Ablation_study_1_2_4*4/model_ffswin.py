...
# ============================================================
# MLP (same for both, expansion factor = 2)
# ============================================================
class Mlp(nn.Module):
...
# ============================================================
# Window Attention (no relative bias for simplicity, but works)
# ============================================================
...
# ============================================================
# 3D Swin Transformer Block (identical for both ablations)
# ============================================================
class SwinTransformerBlock3D(nn.Module):
    def __init__(self, dim, num_heads, window_size=(2,4,4), shift_size=(0,0,0)):
        ...
        self.mlp = Mlp(in_features=dim, hidden_features=int(dim * 4.))   # fixed expansion = 2
...
# ============================================================
# FFSwin Classifier with configurable depth patch
# ============================================================
class FFSwinClassifier(nn.Module):
    def __init__(self, num_classes=3, in_chans=1, embed_dim=96, patch_size=4, depth_patch=1):
        super().__init__()
        # Patch embedding with configurable depth kernel
        self.patch_embed = nn.Conv3d(
            in_chans, embed_dim,
            kernel_size=(depth_patch, patch_size, patch_size),
            stride=(depth_patch, patch_size, patch_size)
        )
        # Four alternating Flop-Flip blocks
